...
public class VisitsService {
     ...
     */
    public boolean updateVisit(Integer passId, @NotBlank LocalDate dateVisit, @NotBlank Integer countVisit) {
    ...
    public boolean minusVisit(Integer passId, int inputNumber, @NotBlank LocalDate specifiedDay) {
